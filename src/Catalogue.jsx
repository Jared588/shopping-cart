...
export const catalogue = {
  shirts: [
    // C-neck
    <CreateItem key="shirtC-0" item='shirtC' title='T-shirt - white' price={19.98} color='white' />,
    <CreateItem key="shirtC-1" item='shirtC' title='T-shirt - grey' price={39.99} color='gray' />,
    <CreateItem key="shirtC-2" item='shirtC' title='T-shirt - black' price={19.98} color='black' />,
  ...
  shoes: [
    ...
    // Heel
    <CreateItem key="shoeHeel-0" item='shoeHeel' title='Heel - black' price={19.98} color='black' />,
    ...
    // Sneaker
    <CreateItem key="shoeSneaker-0" item='shoeSneaker' title='Sneaker - white' price={19.98} color='white' />,
  ...
  misc: [
    ...
    // Tie
    <CreateItem key="tie-0" item='tie' title='Tie - white' price={19.98} color='white' />,
    ...
    <CreateItem key="bow-tie-1" item='bow-tie' title='bow-tie - black' price={19.98} color='black' />,
    // Necklace
